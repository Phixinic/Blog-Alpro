...
<body>
    <div class="nav">
        <div class="links">
            <a href="Login.php"><?php echo $data['Log in'] ?></a>
...
?>
        ...
        <form class="form" action="handel/loginhandel.php" method="post">
            
            <h3><?php echo $data['Login Here'] ?></h3>
            ...
            <button type="submit" name="submit"><?php echo $data['Login'] ?></button>
